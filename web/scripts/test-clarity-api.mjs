...
const clarityPid = parseEnvValue("NIS_DEFAULT_CLARITY_PROJECT_ID");
...
if (!token || !clarityPid) {
  console.error("CLARITY_API_TOKEN or NIS_DEFAULT_CLARITY_PROJECT_ID is missing in .env.local");
  process.exit(1);
}
