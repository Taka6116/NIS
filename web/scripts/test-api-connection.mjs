...
const creds = JSON.parse(parseEnvValue("GOOGLE_SERVICE_ACCOUNT_JSON"));
const gscUrl = parseEnvValue("NIS_DEFAULT_GSC_PROPERTY_URL");
const ga4Id = parseEnvValue("NIS_DEFAULT_GA4_PROPERTY_ID");

console.log("--- NIS API Connection Test ---");
...
try {
  ...
  const [resp] = await client.runReport({
    ...
    dateRanges: [{ startDate: "2026-03-01", endDate: "2026-03-28" }],
